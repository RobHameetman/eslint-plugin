...
/**
 * A destructured input object for the `$meta()` method on the `CustomESLintRule`
 * class.
 */
export interface $MetaMethodInput {
	/**
...
/**
 * Checks that an `unknown` value is an {@link $MetaMethodInput}.
 *
 * Requirements:
 ...
 *
 * @returns The determination that `value` is or is not an {@link $MetaMethodInput}.
 */
export const is$MetaMethodInput = (value: unknown): value is $MetaMethodInput =>
	/**
	 * value
	 */
	isObject(value) &&
