...
import { isCategory } from '@enums/Categories';
import { isFixability } from '@enums/Fixabilities';
...
/**
 * Checks that an `unknown` value is an {@link InfoMethodInput}.
 *
 * Requirements:
 ...
 *
 * @returns The determination that `value` is or is not an {@link InfoMethodInput}.
 */
